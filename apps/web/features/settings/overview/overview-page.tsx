      ...
      <Section>
        ...
        <SectionBody>
          <SimpleGrid columns={[1, null, 3]} spacing={4}>
            <SupportCard
              title="Start Guide"
              description="Read how to get started with arcus AI."
              icon={LuCircleHelp}
              href="https://docs.arcus.ai/getting-started"
            />
            <SupportCard
              title="Features"
              description="Explore our Islamic finance features."
              icon={LuBox}
              href="https://docs.arcus.ai/features"
            />
            <SupportCard
              title="Feedback"
              description="Share your feedback and suggestions."
              icon={LuGithub}
              href="https://feedback.arcus.ai"
            />
          </SimpleGrid>
        </SectionBody>
      </Section>
              ...
              <CardBody>
                <Stack spacing="4">
                  ...
                  <ButtonGroup>
                    <LinkButton
                      variant="outline"
                      href="https://docs.arcus.ai/overview"
                      leftIcon={<FiBook />}
                    >
                      Documentation
                    </LinkButton>
